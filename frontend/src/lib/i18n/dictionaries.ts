...
export const en = {
  ...
  "auth.googleUnavailable": "Google sign-up isn't available in this demo.",
  "auth.apple": "Continue with Apple",
  "auth.appleUnavailable": "Apple sign-up isn't available in this demo.",
  "auth.or": "or",
...
export const ar: Dictionary = {
  ...
  "landing.hero.titleAccent": "وشاهد التحديثات تظهر لحظياً",
  "landing.hero.subtitle":
    "لوحة مهام تعاونية بأسلوب كانبان — اسحب المهام، وتابع التقدّم، وتعاون مع فريقك في الوقت الفعلي.",
  "landing.hero.tryDemo": "جرّب بدون تسجيل",
  "landing.hero.createAccount": "إنشاء حساب مجاني",
  "landing.hero.noCard": "التجربة لا تحتاج بريداً إلكترونياً ولا بطاقة — جرّب فوراً.",
  "landing.features.heading": "كل ما تحتاجه لإدارة مهامك",
  "landing.features.subheading":
    "أدوات بسيطة وسريعة، مصمّمة لتركّز على العمل لا على الأداة.",
  ...
  "landing.feature.realtime.desc":
    "عندما يحرّك زميلك مهمة، تراها تتحرك لديك فوراً — دون أي تحديث للصفحة.",
  "landing.feature.dnd.title": "سحب وإفلات",
  "landing.feature.dnd.desc":
    "حرّك المهام بين الأعمدة بسلاسة، مع تحديث فوري للواجهة قبل وصولها إلى الخادم.",
  "landing.feature.presence.title": "حضور مباشر",
  "landing.feature.presence.desc":
    "شاهد صور الأعضاء الموجودين على اللوحة الآن، واعرف من يعمل معك.",
  "landing.feature.activity.title": "سجل النشاط",
  "landing.feature.activity.desc":
    "تابع كل حركة: من أنشأ مهمة، ومن نقلها، ومتى — في لوحة جانبية واضحة.",
  "landing.feature.priorities.title": "أولويات وتصنيفات",
  "landing.feature.priorities.desc":
    "حدّد أولوية كل مهمة (منخفضة/متوسطة/عالية)، وأضف تواريخ استحقاق وتصنيفات ملوّنة.",
  "landing.cta.heading": "هل أنت مستعد للبدء؟",
  "landing.cta.subtitle":
  ...
  "auth.signup.subtitle": "ابدأ بتنظيم عملك",
  "auth.signup.submit": "إنشاء حساب",
  "auth.signup.haveAccount": "هل تملك حساباً بالفعل؟",
  "auth.signup.loginLink": "تسجيل الدخول",
  "auth.login.forgot": "نسيت كلمة المرور؟",
  "auth.forgot.title": "استعادة كلمة المرور",
  "auth.forgot.subtitle": "سنرسل إليك رابط الاستعادة على بريدك",
  ...
  "auth.placeholder.email": "you@example.com",
  "auth.placeholder.password": "••••••••",
  "auth.placeholder.name": "محمد أحمد",
  "auth.placeholder.newPassword": "٨ أحرف على الأقل",
  "auth.placeholder.confirmPassword": "أعد إدخال كلمة المرور",
  "auth.google": "المتابعة عبر Google",
  "auth.googleUnavailable": "التسجيل عبر Google غير متاح في هذه النسخة التجريبية.",
  "auth.apple": "المتابعة عبر Apple",
  "auth.appleUnavailable": "التسجيل عبر Apple غير متاح في هذه النسخة التجريبية.",
  "auth.or": "أو",
  ...
  "boards.empty.title": "لا تملك أي لوحات بعد",
  ...
  "createBoard.descriptionPlaceholder": "ما الغرض من هذه اللوحة؟",
  ...
  "board.notFound.desc": "هذه اللوحة غير موجودة أو لا تملك صلاحية الوصول إليها.",
  ...
  "task.title": "العنوان",
  "task.titlePlaceholder": "ما المطلوب إنجازه؟",
  ...
  "checklist.readOnly": "يمكن للمحررين فقط تعديل القائمة.",
  ...
  "comments.readOnly": "يمكن للمحررين فقط التعليق.",
  ...
  "activity.empty.desc": "ستظهر الإجراءات على هذه اللوحة هنا.",
  ...
  // --- Demo ---
  "demo.signupToSave": "سجّل لحفظ عملك",
  "demo.banner":
